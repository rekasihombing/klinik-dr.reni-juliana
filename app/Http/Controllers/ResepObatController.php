...
class ResepObatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Perbaikan validasi - lebih spesifik dan dengan pesan error
        $validated = $request->validate([
            ...
            'prescription_items.*.jumlah' => 'required|integer|min:1|max:1000', // Perbaikan validasi
    ...
    if (($item['dari_klinik'] ?? true) && !empty($item['obat_id'])) {
        ...
        // Mulai pengurangan stok dari tabel stok_obat
    ...
    $savedPrescriptions[] = $prescription;
            ...
            return redirect()->back()->with('success', 'Resep obat berhasil disimpan');
