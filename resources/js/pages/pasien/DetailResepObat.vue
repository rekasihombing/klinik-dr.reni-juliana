    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white rounded-lg shadow-sm border">
        <div class="px-6 py-4 border-b border-gray-200">
          ...
          <p class="text-sm text-gray-600 mt-1">{{ resepObat.length }} jenis obat diresepkan</p>
        </div>
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div v-if="obat.status_aktif">
                      ...
                      <p class="text-sm text-gray-900 font-medium">
                        {{ Math.max(0, obat.sisa_hari) }} hari
                      </p>
                    </div>
                  </div>
        ...
        <!-- Empty State -->
        <div v-if="resepObat.length === 0" class="text-center py-12">
      ...
      <!-- Summary Card -->
      <div v-if="resepObat.length > 0" class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div class="flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <span class="text-blue-900 ml-1">{{ resepObat.length }} jenis</span>
              </div>
              <div>
              ...
              <div>
                <span class="text-blue-700 font-medium">Dari Klinik:</span>
                <span class="text-blue-900 ml-1">{{ klinikObatCount }} obat</span>
              </div>
            </div>
            <p class="text-xs text-blue-700 mt-3">
              <strong>Catatan:</strong> Pastikan untuk mengikuti dosis dan jadwal yang telah ditentukan. Jika ada efek samping atau pertanyaan, segera konsultasi dengan dokter.
            </p>
          </div>
        </div>
      </div>
...
const klinikObatCount = computed(() => {
  return props.resepObat.filter(obat => obat.dari_klinik).length
})
