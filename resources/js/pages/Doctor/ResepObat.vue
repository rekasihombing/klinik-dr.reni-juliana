      ...
      <main class="bg-gray-100 flex-1 p-6 font-sans text-[13px] leading-tight text-black">
        ...
        <div class="max-w-7xl mx-auto px-6 py-8">
          <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <!-- Patient Info Bar -->
            <div class="bg-gradient-to-r from-[#3674B5] to-[#4a7bc8] px-8 py-6">
    ...
    {{ dateValidationErrors[index] }}
                          ...
                          <div>
                            ...
                            <textarea 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none text-gray-700" 
                    ...
                    <div class="mt-6">
                      <button
                        type="button"
                        @click="addItem"
                        class="flex items-center space-x-2 px-6 py-3 bg-[#00B87A] hover:bg-[#109568] text-white rounded-lg font-medium transition-all shadow-lg"
                      >
                ...
                <div v-show="activeTab === 'luar'" class="space-y-6">
                  <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                      ...
                      <textarea 
                        v-model="obatLuar"
                        class="w-full px-4 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all resize-none text-gray-700" 
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                  ...
                  <div class="flex items-center space-x-4">
                    <button
                      type="button"
                      @click="cancelForm"
                      class="px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-medium transition-all shadow-lg"
                    >
                    ...
                    <button
                      ...
                      :class="[
                        'px-6 py-3 text-white rounded-lg font-medium transition-all shadow-lg',
                        (activeTab === 'klinik' && hasStokTidakCukup) || isSubmitting
                          ? 'bg-gray-400 cursor-not-allowed'
                          : 'bg-[#3F86D0] hover:bg-[#3B59A1]'
                      ]"
                    >
        ...
        >
          <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center transform transition-all">
            ...
            <button
              ...
              class="w-full bg-[#00B87A] hover:bg-[#109568] text-white py-3 px-6 rounded-lg font-medium transition-all"
            >
              Tutup
            </button>
          </div>
        ...
        >
          <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
            ...
            <button
              ...
              class="w-full bg-[#3F86D0] hover:bg-[#3B59A1] text-white py-3 px-6 rounded-lg font-medium transition-all"
            >
              Mengerti
            </button>
          </div>
