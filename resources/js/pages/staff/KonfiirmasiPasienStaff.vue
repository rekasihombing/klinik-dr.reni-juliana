        ...
        <div class="overflow-y-auto max-h-[calc(90vh-100px)]">
          <div class="px-6 py-6">
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
              ...
              <button
                @click="editPasien"
                class="inline-flex items-center px-6 py-2 text-sm font-medium rounded-lg text-white bg-[#3F86D0] hover:bg-[#3B59A1] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
